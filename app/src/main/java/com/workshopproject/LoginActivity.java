...
import com.workshopproject.dbhelpers.LoginDAO;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void login() {
        ...
        String password = _passwordText.getText().toString();
            ...
            boolean result = InsertUser(email,password);
            if(result) {
                InsertPreferences(email, password);
        ...
        private boolean InsertUser(String Email, String Password)
        {
            ...
            boolean res = loginDAO.CheckUser(Email,Password);
            if(res) return true;
            else
                return false;
        }
    public void InsertPreferences(String Email, String password) {
